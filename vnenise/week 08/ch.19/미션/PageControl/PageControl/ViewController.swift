...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let pinch = UIPinchGestureRecognizer(target: self, action: #selector(ViewController.respondToPinchGesture(_:)))
    ...
    func respondToPinchGesture(_ gesture: UIPinchGestureRecognizer){
